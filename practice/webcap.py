...
SNAPSHOT_PATH = 'D:/ic_files/SNAPSHOT/20170927/'
#创建快照文件夹
...
def select():
	try:
		...
		sql = 'select Article_ID, Article_URL FROM Article where Creation_Date regexp "2017-09-27.*" and Program_Tag="BaiduSpider_GGF"and Snapshot_URL =""'
		cur.execute(sql)
